/* [build] 20-i18n.js  (I18N strings, t(), lang state, field helpers, HRMOS data override, BLURB) - concatenated in load order by build.ps1; all parts share one IIFE scope */
  /* ---------------- i18n ---------------- */
  var I18N = {
    en:{
      ...
      csu_cta:"Sign up free", csu_trust:"Curated in Tokyo by Neo and the LongWave team.",
