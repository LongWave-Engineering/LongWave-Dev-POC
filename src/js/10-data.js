/* [build] 10-data.js  (built-in demo fallback: COMPANIES/SPECS/JOBS/JOBS_JA/COMPANY_LIST/REVIEWS/ARTICLES) - concatenated in load order by build.ps1; all parts share one IIFE scope */
  /* ---------------- data ---------------- */
  var COMPANIES = {
  ...
  var JOBS = [
    ...
    {co:"tt", role:"Senior Product Manager (Sr. PdM)", spec:"Product Management", salary:"¥6.5M – ¥12M", jp:"business", remote:"partial", abroad:false, visa:false, hot:true, loc:"Tokyo · Ginza", stack:["B2B SaaS","Product Discovery","Roadmapping"],
    ...
    {co:"tt", role:"SRE & Platform Specialist", spec:"SRE / Platform", salary:"¥8M – ¥13M", jp:"business", remote:"partial", abroad:false, visa:false, hot:true, loc:"Tokyo · Ginza", stack:["Go","AWS","Terraform","Security"],
    ...
    {co:"tt", role:"SRE & Platform Engineer", spec:"SRE / Platform", salary:"¥6M – ¥8.4M", jp:"business", remote:"partial", abroad:false, visa:false, hot:true, loc:"Tokyo · Ginza", stack:["Go","AWS","Terraform"],
    ...
    {co:"tt", role:"Analytics Engineer", spec:"Data Engineering", salary:"¥7M – ¥10M", jp:"business", remote:"partial", abroad:false, visa:false, hot:false, loc:"Tokyo · Ginza", stack:["dbt","SQL","Snowflake","Python"],
    ...
    {co:"tt", role:"SRE & Platform Manager (candidate)", spec:"SRE / Platform", salary:"¥9.5M – ¥13M", jp:"business", remote:"partial", abroad:false, visa:false, hot:false, loc:"Tokyo · Ginza", stack:["Go","AWS","Terraform","Leadership"],
    ...
    {co:"tt", role:"Software Engineer in Test (SET)", spec:"QA / Test", salary:"¥6M – ¥12M", jp:"business", remote:"partial", abroad:false, visa:false, hot:false, loc:"Tokyo · Ginza", stack:["Playwright","TypeScript","Go","CI/CD"],
    ...
    {co:"tt", role:"QA Engineer", spec:"QA / Test", salary:"¥5M – ¥8.5M", jp:"business", remote:"partial", abroad:false, visa:false, hot:false, loc:"Tokyo · Ginza", stack:["Test Design","Qase","BrowserStack"],
    ...
    {co:"tt", role:"Customer Success Engineer (CSE)", spec:"Customer Success Eng", salary:"¥5.5M – ¥9.5M", jp:"business", remote:"partial", abroad:false, visa:false, hot:false, loc:"Tokyo · Ginza", stack:["JavaScript","Python","AWS"],
