/* core/i18n-data.js — the EN/JA string dictionary, split out of i18n.js so it is
  ...
  var I18N = {
    en:{
      ...
      jobs_partners_lab:"Teams we've placed engineers with",
    ...
    ja:{
      ...
      jobs_partners_lab:"エンジニアの入社実績がある企業",
      partners_post_h:"採用を支援している企業",
      partners_post_sub:"LongWaveと一緒に、バイリンガルチームづくりを進めている企業の一部です。",
      ...
      t_sub:"LongWaveは、バイリンガルや海外出身のエンジニアを、日本を代表するプロダクト企業へつなぐ東京のリクルーティングチームです。給与も日本語レベルも、最初から明確に。",
      ...
      post_sub:"LongWaveに求人を掲載いただくと、バイリンガルのリクルーターが、技術スタックと日本語レベルで事前に見極めた候補者だけをご紹介します。本当に合う人にだけ、お会いいただけます。",
      ...
      comp_h1:"取引企業",
      comp_sub:"LongWaveとつながりのある企業です（現在採用を支援しているチームや、エンジニアをご紹介した実績のある企業を含みます）。求人が掲載されていなくても、お気軽にお問い合わせください。非公開の求人をお預かりしていることもあります。",
