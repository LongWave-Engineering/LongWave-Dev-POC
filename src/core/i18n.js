/* core/i18n.js — i18n strings, t(), field helpers, HRMOS override, per-job enrichment */
  ...
  var I18N = {
    en:{
      ...
      ct_title:"Contact us", ct_intro:"A question for the LongWave team? Send it here and we'll reply by email.",
      ct_subject:"Subject of enquiry", ct_message:"What are you enquiring about?", ct_submit:"Send message",
      ct_success:"Thanks — we'll get back to you by email soon.",
    ...
    ja:{
      ...
      ct_title:"お問い合わせ", ct_intro:"LongWaveチームへのご質問はこちらから。メールでご返信します。",
      ct_subject:"お問い合わせの件名", ct_message:"お問い合わせ内容", ct_submit:"送信する",
      ct_success:"ありがとうございます。追ってメールでご連絡します。",
