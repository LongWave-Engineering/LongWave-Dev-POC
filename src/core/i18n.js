/* core/i18n.js — i18n strings, t(), field helpers, HRMOS override, per-job enrichment */
  ...
  var I18N = {
    en:{
      ...
      su_loc_warn:"Most roles require you to already be in Japan with valid working status, so options may be limited — but we'll be honest about fit.",
    ...
    ja:{
      ...
      su_loc_warn:"多くの求人は、日本在住かつ有効な就労資格があることが前提のため、ご紹介できる求人が限られる場合があります。相性については正直にお伝えします。",
