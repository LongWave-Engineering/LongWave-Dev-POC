/* core/i18n.js — i18n strings, t(), field helpers, HRMOS override, per-job enrichment */
  ...
  var I18N = {
    en:{
      ...
      jobs_placed_h:"Engineers we've placed", jobs_placed_sub:"A few of the teams our candidates have joined.",
      art_h1:"Articles",
      ...
      cv_note_fill:"Pre-filled with a sample — edit it, or “Clear all” to start fresh. Save progress to come back to it later. Hover the ⓘ on any field for tips.",
    ...
    ja:{
      ...
      jobs_placed_h:"私たちの紹介実績", jobs_placed_sub:"私たちの候補者が入社したチームの一例です。",
      art_h1:"記事",
      ...
      cv_print:"印刷・PDFで保存",
      cv_note_fill:"サンプルが入力済みです。編集するか「全てクリア」で最初から作成できます。「保存する」で後から続きを作成できます。各項目のⓘにカーソルを合わせるとヒントが表示されます。",
