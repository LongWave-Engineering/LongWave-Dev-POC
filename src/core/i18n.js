/* core/i18n.js — i18n strings, t(), field helpers, HRMOS override, per-job enrichment */
  ...
  var I18N = {
    en:{
      ...
      cv_note_fill:"Pre-filled with a sample — edit it, or “Clear all” to start fresh. Hover the ⓘ on any field for tips.",
      cv_clear:"Clear all",
    ...
    ja:{
      ...
      cv_print:"印刷・PDFで保存",
      cv_note_fill:"サンプルが入力済みです。編集するか「全てクリア」で最初から作成できます。各項目のⓘにカーソルを合わせるとヒントが表示されます。",
      cv_clear:"全てクリア",
