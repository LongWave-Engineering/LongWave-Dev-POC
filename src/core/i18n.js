/* core/i18n.js — t(), field/lang helpers, HRMOS override, per-job enrichment.
  ...
  /* The card headline is a canonical label ("Backend Engineer"); the adapter
     ...
     extra to say. */
  function roleDetailL(j){
    /* EN ONLY. The adapter canonicalizes the ENGLISH title and parks the
       posting's own title in role_full; role_ja is never canonicalized, so in
       Japanese the headline IS the full title and a second line would just
