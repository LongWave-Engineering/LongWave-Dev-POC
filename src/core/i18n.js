/* core/i18n.js — i18n strings, t(), field helpers, HRMOS override, per-job enrichment */
  ...
  var I18N = {
    en:{
      ...
      comp_roles:"{n} open roles", comp_view:"View roles →",
      comp_placed:"Placed here", comp_interested:"Interested in {co}?", comp_ask:"Ask about roles →",
      inq_title:"Ask about roles at {co}", inq_success:"Thanks — a bilingual recruiter will be in touch about roles at {co}.",
    ...
    ja:{
      ...
      comp_roles:"募集中 {n}件", comp_view:"求人を見る →",
      comp_placed:"紹介実績", comp_interested:"{co}に興味がありますか？", comp_ask:"求人について問い合わせる →",
      inq_title:"{co}の求人について問い合わせる", inq_success:"ありがとうございます。{co}の求人について、バイリンガルのリクルーターからご連絡します。",
